 ...
 */
typedef bool (*cyaml_validate_int_fn_t)(void *ctx,
 ...
 * \return `true` if values is valid, `false` otherwise.
 */
typedef bool (*cyaml_validate_uint_fn_t)(void *ctx,
                                         const cyaml_schema_value_t *schema,
                                         uint64_t value);
 ...
 * \return `true` if values is valid, `false` otherwise.
 */
typedef bool (*cyaml_validate_float_fn_t)(void *ctx,
                                          const cyaml_schema_value_t *schema,
                                          double value);
 ...
 * \return `true` if values is valid, `false` otherwise.
 */
typedef bool (*cyaml_validate_string_fn_t)(void *ctx,
                                           const cyaml_schema_value_t *schema,
                                           const char *value);
 ...
 * \return `true` if values is valid, `false` otherwise.
 */
typedef bool (*cyaml_validate_mapping_fn_t)(void *ctx,
                                            const cyaml_schema_value_t *schema,
 ...
 * \return `true` if values is valid, `false` otherwise.
 */
typedef bool (*cyaml_validate_sequence_fn_t)(void *ctx,
                                             const cyaml_schema_value_t *schema,
 ...
 */
#define CYAML_VALUE(_TYPE, _flags, _type, ...)                                 \
  .type = CYAML_##_TYPE, .flags = (enum cyaml_flag)(_flags),                   \
  .data_size = sizeof(_type), CYAML__UNION_MEMBER_##_TYPE = __VA_ARGS__
 ...
 *                         \ref cyaml_schema_value anonymous union member.
 */
#define CYAML_FIELD(_TYPE, _key, _flags, _structure, _member, ...)             \
  {                                                                            \
    .key = _key, .data_offset = offsetof(_structure, _member),                 \
    .value = {                                                                 \
        CYAML_VALUE(_TYPE, CYAML__POINTER_REMOVE(_flags),                      \
                    CYAML__MEMBER(_structure, _member), __VA_ARGS__),          \
    },                                                                         \
  }
 ...
 *                         \ref cyaml_schema_value anonymous union member.
 */
#define CYAML_FIELD_PTR_COUNT(_TYPE, _key, _flags, _structure, _member,        \
                              _count, ...)                                     \
  {                                                                            \
    .key = _key, .data_offset = offsetof(_structure, _member),                 \
    ...
    .value = {                                                                 \
        CYAML_VALUE(_TYPE, CYAML__HANDLE_PTR_##_TYPE(_flags),                  \
                    *CYAML__MEMBER(_structure, _member), __VA_ARGS__),         \
    },                                                                         \
  }
 ...
 *                         \ref cyaml_schema_value anonymous union member.
 */
#define CYAML_FIELD_PTR(_TYPE, _key, _flags, _structure, _member, ...)         \
 ...
 * \param[in]  _type          The C type for this value.
 */
#define CYAML_VALUE_INT(_flags, _type) CYAML_VALUE(INT, _flags, _type, {0})
 ...
 * \param[in]  _type          The C type for this value.
 */
#define CYAML_VALUE_UINT(_flags, _type) CYAML_VALUE(UINT, _flags, _type, {0})
 ...
 * \param[in]  _type          The C type for this value.
 */
#define CYAML_VALUE_BOOL(_flags, _type) CYAML_VALUE(BOOL, _flags, _type, {0})
 ...
 * \param[in]  _type          The C type for this value.
 */
#define CYAML_VALUE_FLOAT(_flags, _type) CYAML_VALUE(FLOAT, _flags, _type, {0})
 ...
 * \param[in]  _strings_count Number of entries in _strings.
 */
#define CYAML_FIELD_ENUM(_key, _flags, _structure, _member, _strings,          \
                         _strings_count)                                       \
 ...
 * \param[in]  _strings_count Number of entries in _strings.
 */
#define CYAML_FIELD_ENUM_PTR(_key, _flags, _structure, _member, _strings,      \
                             _strings_count)                                   \
 ...
 * \param[in]  _strings_count Number of entries in _strings.
 */
#define CYAML_FIELD_FLAGS(_key, _flags, _structure, _member, _strings,         \
                          _strings_count)                                      \
 ...
 * \param[in]  _strings_count Number of entries in _strings.
 */
#define CYAML_FIELD_FLAGS_PTR(_key, _flags, _structure, _member, _strings,     \
                              _strings_count)                                  \
 ...
 * \param[in]  _bitvals_count Number of entries in _bitvals.
 */
#define CYAML_FIELD_BITFIELD(_key, _flags, _structure, _member, _bitvals,      \
                             _bitvals_count)                                   \
 ...
 * \param[in]  _bitvals_count Number of entries in _bitvals.
 */
#define CYAML_FIELD_BITFIELD_PTR(_key, _flags, _structure, _member, _bitvals,  \
                                 _bitvals_count)                               \
 ...
 * \param[in]  _key        String defining the YAML mapping key for this value.
 * \param[in]  _flags      Any behavioural flags relevant to this value.
 * \param[in]  _structure  The structure corresponding to the containing
 * mapping. \param[in]  _member     The member in _structure for this mapping
 * value. \param[in]  _fields     Pointer to mapping fields schema array.
 */
 ...
 * \param[in]  _max        Maximum number of sequence entries required.
 */
#define CYAML_FIELD_SEQUENCE(_key, _flags, _structure, _member, _entry, _min,  \
                             _max)                                             \
 ...
 * \param[in]  _max        Maximum number of sequence entries required.
 */
#define CYAML_FIELD_SEQUENCE_COUNT(_key, _flags, _structure, _member, _count,  \
                                   _entry, _min, _max)                         \
  CYAML_FIELD_PTR_COUNT(SEQUENCE, _key, _flags, _structure, _member, _count,   \
                        {                                                      \
                            .entry = _entry,                                   \
                            .min = _min,                                       \
                            .max = _max,                                       \
 ...
 * \param[in]  _count      Number of sequence entries required.
 */
#define CYAML_FIELD_SEQUENCE_FIXED(_key, _flags, _structure, _member, _entry,  \
                                   _count)                                     \
 ...
 */
typedef void (*cyaml_log_fn_t)(cyaml_log_t level, void *ctx, const char *fmt,
                               va_list args);
 ...
 *                   be treated as free().
 * \return If `size == 0`, returns NULL.  If `size > 0`, returns NULL on
 * failure, and any existing allocation is left untouched, or return non-NULL as
 ...
 * \param[in] args   Additional arguments used by fmt.
 */
extern void cyaml_log(cyaml_log_t level, void *ctx, const char *fmt,
                      va_list args);
 ...
 *         invalid.
 */
extern void *cyaml_mem(void *ctx, void *ptr, size_t size);
 ...
 */
extern cyaml_err_t cyaml_load_file(const char *path,
 ...
 * \return \ref CYAML_OK on success, or appropriate error code otherwise.
 */
extern cyaml_err_t cyaml_load_data(const uint8_t *input, size_t input_len,
                                   const cyaml_config_t *config,
                                   const cyaml_schema_value_t *schema,
                                   cyaml_data_t **data_out,
                                   unsigned *seq_count_out);
 ...
 * \return \ref CYAML_OK on success, or appropriate error code otherwise.
 */
extern cyaml_err_t cyaml_save_file(const char *path,
                                   const cyaml_config_t *config,
                                   const cyaml_schema_value_t *schema,
 ...
 * \return \ref CYAML_OK on success, or appropriate error code otherwise.
 */
extern cyaml_err_t cyaml_save_data(char **output, size_t *len,
                                   const cyaml_config_t *config,
                                   const cyaml_schema_value_t *schema,
                                   const cyaml_data_t *data,
                                   unsigned seq_count);
 ...
 * \return \ref CYAML_OK on success, or appropriate error code otherwise.
 */
extern cyaml_err_t cyaml_copy(const cyaml_config_t *config,
                              const cyaml_schema_value_t *schema,
                              const cyaml_data_t *data, unsigned seq_count,
                              cyaml_data_t **data_out);
 ...
 * \return \ref CYAML_OK on success, or appropriate error code otherwise.
 */
extern cyaml_err_t cyaml_free(const cyaml_config_t *config,
                              const cyaml_schema_value_t *schema,
 ...
 *         by libcyaml.
 */
extern const char *cyaml_strerror(cyaml_err_t err);
